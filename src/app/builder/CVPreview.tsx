    ...
    <div className={`bg-white shadow-2xl border ${isMini ? 'scale-[0.5] origin-top' : ''} p-10 max-w-[210mm] mx-auto min-h-[297mm]`}>
      <div className="grid grid-cols-[180px_1fr] gap-8">
        ...
        <aside className="space-y-8">
          ...
          {cvData.personal.dob && (
            <div className="space-y-1">
              <p className="text-[10px] tracking-widest uppercase text-muted-foreground font-bold">Personal</p>
              <div className="text-[10px] space-y-0.5">
            ...
            <div className="space-y-2">
              {cvData.education.map((ed) => (
                <div key={ed.id} className="text-[10px]">
                  ...
                  {ed.location && <p className="text-muted-foreground opacity-70">{ed.location}</p>}
          ...
          {(cvData.chance.visaStatus || cvData.chance.availability) && (
            <div className="space-y-1">
              <p className="text-[10px] tracking-widest uppercase text-muted-foreground font-bold">Visa & Availability</p>
              <div className="text-[10px] space-y-0.5">
                {cvData.chance.visaStatus && <p>{cvData.chance.visaStatus}</p>}
                {cvData.chance.availability && <p>{cvData.chance.availability}</p>}
